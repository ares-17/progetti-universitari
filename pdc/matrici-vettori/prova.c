...
#define NUM_COLUMNS_A 8 //columns of input [A]
#define NUM_ROWS_B 8 //rows of input [B]
...
int main(int argc, char *argv[])
{
    ...
    if (rank == 0) {
        ...
        for (i = 1; i < size; i++) {//for each slave other than the master
            ...
            printf("process : %d\t porzione %d\t low_bound %d\t upper_bound %d \n",i,portion,low_bound,upper_bound);
